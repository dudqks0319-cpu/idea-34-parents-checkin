...
import 'package:app_34_parents_checkin/app.dart';
import 'package:app_34_parents_checkin/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('부모님 안부 체크'), findsWidgets);
